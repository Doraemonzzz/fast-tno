...
template<bool QV, int HEADDIM, typename FFT, typename IFFT, typename input_t, typename output_t=input_t, bool GELU_INPUT=false, bool GELU_OUTPUT=false, bool GELU_Q=false>
